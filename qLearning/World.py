...
player = (1, y-1) #where the player starts
score = 1
restart = False
walk_reward = -0.04
...
cell_scores = {}
# If you want to visualize the triangles, you'll have to change the
# two functions below with show_tri
...
def render_grid(show_tri=False):
...
def set_cell_score(state, action, val, show_tri=False):
